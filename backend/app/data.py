...
def get_stock_info(ticker: str) -> dict:
    ...
    try:
        ...
        result = {
            ...
            "fiftyTwoWeekHigh": stock.fast_info.year_high or info.get("fiftyTwoWeekHigh"),
            "fiftyTwoWeekLow": stock.fast_info.year_low or info.get("fiftyTwoWeekLow"),
            "dividendRate": info.get("dividendRate"),
            "dividendYield": info.get("dividendYield"),
            "currency": stock.fast_info.currency or info.get("currency", "USD"),
            "shortName": info.get("shortName"),
            "longName": info.get("longName"),
            "sector": info.get("sector"),
            "industry": info.get("industry"),
            "exDividendDate": info.get("exDividendDate"),
            "lastDividendValue": stock.fast_info.last_dividend_value or info.get("lastDividendValue"),
            "trailingEps": info.get("trailingEps"),
            "volume": stock.fast_info.last_volume or info.get("regularMarketVolume") or info.get("volume"),
